...

{
    ...
    //nameDoesMatter();
    console.log(_sayHello2.default);
    sayHello();
...
var gimmeANiceMsg = function gimmeANiceMsg() {
    console.log('Ere is a noice message');
};

var exportObj = { name: 'export object', value: 999 };

//module.exports = gimmeANiceMsg;
